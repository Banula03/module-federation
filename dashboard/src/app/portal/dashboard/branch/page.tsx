  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-6 text-center">
      ...
      <div className="space-y-2">
        <h1 className="text-3xl font-bold text-black">Branch Management</h1>
      ...
      <Link
        ...
        className="inline-flex items-center gap-2 mt-4 px-4 py-2 rounded-xl bg-gray-800 text-gray-300 hover:text-black hover:bg-gray-700 text-sm font-medium transition-all duration-200"
      >
